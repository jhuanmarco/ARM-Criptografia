...
@----------- CRIPTOGRAFIA
			...
			mov		r12, r4				@ R11 RECEBE O TAMANHO DA MENSAGEM (R11 É USADO POSTERIORMENTE PARA DESCRIPTOGRAFAR, VISTO QUE R4 É USADO PARA OUTRAS TAREFAS ATÉ LÁ [LINHA 270])
...
@----------- DESCRIPTOGRAFIA
		...
		descriptografar:
			...
			strb	r2, [r8, r6]		@ ARMAZENA NA MENSAGEM O RESULTADO DA SUBTRACAO
...
@----------- EXIBE DESCRIPTOGRAFIA
			...
			mov		r0,	#1				@ 1 PARA WRITE, 0 PARA READ
			ldr     r1, =mensagem		@ R1 CONTEM ENDEREÇO DA MENSAGEM
